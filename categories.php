        ...
        <div class="row">
            <div class="col-sm-4 text-info rounded p-2 bg-dark" style="border-right: 2px solid #fff;">
                <div class="row mb-2 p-4">
                    <div class="col-sm-12">
                        <h3 class="text-center"><strong>Create Category</strong></h3>
                    </div>
                </div>                
                <div class="mt-3 p-3 text-white">              
                    <form action="_actions/category-store.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-outline-success float-end mb-5"><i class="fa fa-save"></i> Save</button>
                    </form>
                </div>
            </div>
            <div class="col-sm-8 bg-dark text-info p-3 rounded" style="border-left: 2px solid #fff;">
                ...
                <div class="table-responsive p-3" style="height: 460px;">              
